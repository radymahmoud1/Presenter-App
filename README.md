...
It brings together essential presentation features such as drawing, highlighting, zooming, and spotlighting — all in one lightweight application that works seamlessly in the background. It's recommended to disable it after ending your session to start typing the key letters on your keyboard. 
...
🚀 Project Vision
This project was created to overcome limitations caused by discontinued or unsupported official software.
...
**Motivation**
Due to the lack of continued support from Baseus for their presenter software, this project aims to provide an open, extensible alternative for users who rely on such devices in professional and educational environments.
